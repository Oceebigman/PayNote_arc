...
<body>
  ...
  <div class="banner">
    ...
    <div class="banner-reason">${r.reason}</div>
  ...
  <div class="tx-box">
    ...
    <div class="tx-hash">${r.tx_hash}</div>
  </div>

  <div class="footer">
    <div class="footer-text">
      This receipt is an immutable proof-of-settlement object.<br>
      Verify on ArcScan: <a class="footer-url" href="https://testnet.arcscan.app/tx/${r.tx_hash}">testnet.arcscan.app</a><br>
      Receipt URL: <a class="footer-url" href="${appUrl}/receipt/${r.id}">${appUrl}/receipt/${r.id}</a><br><br>
